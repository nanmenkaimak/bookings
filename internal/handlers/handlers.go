...
import (
	...
	"github.com/nanmenkaimak/bookings/internal/forms"
	...
	"github.com/nanmenkaimak/bookings/internal/repository/dbrepo"
)
...
func NewTestRepo(a *config.AppConfig) *Repository { //creates new repository
	return &Repository{
		App: a,
...
// takes URL parameteres, build sessional variable, and takes user to make res screen
...
func (m *Repository) AdminPostShowReservation(w http.ResponseWriter, r *http.Request) {
	...
	m.App.Session.Put(r.Context(), "flash", "Changes saves")
