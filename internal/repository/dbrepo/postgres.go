...
// insert a reservation into to the database
...
// return true if availability exists for roomID, and false if no availability
...
// returns a slice of availabile rooms, if any, for given date range
...
// returns slice of all reservations
...
// returns slice of all new reservations
